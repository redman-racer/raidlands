...
INSERT INTO raidlands_vip_kit_screenshot_targets (kit_name, required_permission)
VALUES
  ('vip', 'kits.vip'),
  ('vip_plus', 'kits.vipplus'),
  ('mvp', 'kits.mvp'),
  ('golden', 'kits.goldenvip'),
  ('ultimate', 'kits.ultimatevip'),
  ('titan', 'kits.titanvip');
...
VALUES
  ...
  ('vip', 'main', 3, 'weapon.mod.small.scope', NULL, 0, 100, 0.00, 0.00, 0, NULL, 30),
  ('vip', 'main', 4, 'weapon.mod.holosight', NULL, 0, 100, 300.00, 300.00, 0, NULL, 40),
  ...
  ('vip', 'main', 9, 'weapon.mod.8x.scope', NULL, 0, 100, 0.00, 0.00, 0, NULL, 90),
  ('vip', 'main', 10, 'weapon.mod.silencer', NULL, 0, 100, 100.00, 100.00, 0, NULL, 100),
  ('vip', 'main', 11, 'weapon.mod.lasersight', NULL, 0, 100, 300.00, 300.00, 0, NULL, 110),
  ...
  ('vip', 'main', 19, 'gunpowder', NULL, 0, 1500, 0.00, 0.00, 0, NULL, 190),
  ...
  ('vip_plus', 'main', 3, 'weapon.mod.small.scope', NULL, 0, 100, 0.00, 0.00, 0, NULL, 30),
  ('vip_plus', 'main', 4, 'weapon.mod.holosight', NULL, 0, 100, 300.00, 300.00, 0, NULL, 40),
  ...
  ('vip_plus', 'main', 9, 'weapon.mod.8x.scope', NULL, 0, 100, 0.00, 0.00, 0, NULL, 90),
  ('vip_plus', 'main', 10, 'weapon.mod.silencer', NULL, 0, 100, 100.00, 100.00, 0, NULL, 100),
  ('vip_plus', 'main', 11, 'weapon.mod.lasersight', NULL, 0, 100, 300.00, 300.00, 0, NULL, 110),
  ...
  ('vip_plus', 'main', 19, 'gunpowder', NULL, 0, 5000, 0.00, 0.00, 0, NULL, 190),
  ...
  ('mvp', 'main', 3, 'ammo.rocket.sam', NULL, 0, 500, 0.00, 0.00, 0, NULL, 30),
  ...
  ('mvp', 'main', 13, 'gunpowder', NULL, 0, 1250, 0.00, 0.00, 0, NULL, 130),
  ...
  ('golden', 'main', 3, 'ammo.rocket.sam', NULL, 0, 50000, 0.00, 0.00, 0, NULL, 30),
  ...
  ('golden', 'main', 13, 'gunpowder', NULL, 0, 10000, 0.00, 0.00, 0, NULL, 130),
  ...
  ('ultimate', 'main', 7, 'ammo.rocket.sam', NULL, 0, 100000, 0.00, 0.00, 0, NULL, 70),
  ...
  ('ultimate', 'main', 11, 'healingtea.pure', NULL, 0, 100, 0.00, 0.00, 0, NULL, 110),
  ('ultimate', 'main', 12, 'weapon.mod.small.scope', NULL, 0, 100, 0.00, 0.00, 0, NULL, 120),
  ('ultimate', 'main', 13, 'weapon.mod.lasersight', NULL, 0, 100, 300.00, 300.00, 0, NULL, 130),
  ('ultimate', 'main', 14, 'weapon.mod.holosight', NULL, 0, 100, 300.00, 300.00, 0, NULL, 140),
  ...
  ('ultimate', 'main', 19, 'gunpowder', NULL, 0, 30000, 0.00, 0.00, 0, NULL, 190),
  ('ultimate', 'main', 20, 'weapon.mod.flashlight', NULL, 0, 100, 0.00, 0.00, 0, NULL, 200),
  ...
  ('ultimate', 'main', 24, 'largemedkit', NULL, 0, 5000, 0.00, 0.00, 0, NULL, 240),
  ('ultimate', 'main', 25, 'bandage', NULL, 0, 5000, 0.00, 0.00, 0, NULL, 250),
  ('ultimate', 'main', 27, 'scrap', NULL, 0, 100000, 0.00, 0.00, 0, NULL, 270),
  ('ultimate', 'main', 28, 'rifle.l96', NULL, 0, 1, 60.00, 60.00, 0, 'ammo.rifle', 280),
  ('ultimate', 'main', 29, 'multiplegrenadelauncher', NULL, 0, 1, 200.00, 200.00, 0, 'ammo.grenadelauncher.he', 290),
  ...
  ('titan', 'main', 13, 'metal.fragments', NULL, 0, 50000000, 0.00, 0.00, 0, NULL, 130),
  ...
  ('titan', 'main', 19, 'gunpowder', NULL, 0, 500000, 0.00, 0.00, 0, NULL, 190),
  ...
  ('titan', 'main', 24, 'weapon.mod.holosight', NULL, 0, 5000, 300.00, 300.00, 0, NULL, 240),
  ('titan', 'main', 25, 'weapon.mod.lasersight', NULL, 0, 5000, 300.00, 300.00, 0, NULL, 250),
  ('titan', 'main', 27, 'smg.mp5', NULL, 0, 1, 150.00, 150.00, 8, 'ammo.pistol', 270),
  ('titan', 'main', 28, 'rifle.l96', NULL, 0, 1, 60.00, 60.00, 2, 'ammo.rifle', 280),
  ('titan', 'main', 29, 'multiplegrenadelauncher', NULL, 0, 1, 200.00, 200.00, 0, 'ammo.grenadelauncher.he', 290),
