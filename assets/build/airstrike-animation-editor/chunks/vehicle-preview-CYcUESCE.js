import{ah as X,l as b,v as oo,ai as T,aj as R,o as c,V as u,J as eo,ak as to,b as w,S as F,n as l,s as V,al as io,G as N,M as U,am as no,k as G,an as ao,f as W,B as lo,g as ro}from"./three.module-D6b-X6ON.js";import{D as so,G as co,M as uo}from"./meshopt_decoder.module-CAcOqU33.js";import{u as H}from"./coordinates-CObBfZRh.js";const E=new Map,B=new Map;function $(o){return o.userData.preserveSharedAsset=!0,o}function Uo(o){return!!(o&&typeof o=="object"&&o.userData?.preserveSharedAsset===!0)}async function mo(o){let e=E.get(o);return e||(e=new X().loadAsync(o).then(t=>$(t)),E.set(o,e)),e}function ho(o,e){const t=B.get(o);if(t)return t;const n=$(e());return n.colorSpace=n.colorSpace||b,B.set(o,n),n}const po={low:{detail:"low",viewSamples:0,lightSamples:0,shadowOctaves:0,useVolumetricClouds:!1,useSpriteClouds:!0},medium:{detail:"medium",viewSamples:32,lightSamples:2,shadowOctaves:2,useVolumetricClouds:!0,useSpriteClouds:!1},max:{detail:"max",viewSamples:56,lightSamples:4,shadowOctaves:4,useVolumetricClouds:!0,useSpriteClouds:!1}};function fo(o,e="low"){return o==="low"||o==="medium"||o==="max"?o:e}function vo(o){return po[o]}function yo(o){const e=Number(o);return Number.isFinite(e)?Math.min(1,Math.max(0,e)):0}const Co={low:{detail:"low",shaderLevel:0,useAtmosphericDisc:!1,useCinematicOptics:!1,lightingResponse:0},medium:{detail:"medium",shaderLevel:1,useAtmosphericDisc:!0,useCinematicOptics:!1,lightingResponse:.55},max:{detail:"max",shaderLevel:2,useAtmosphericDisc:!0,useCinematicOptics:!0,lightingResponse:1}};function xo(o,e="low"){return o==="low"||o==="medium"||o==="max"?o:e}function go(o){return Co[o]}const M="raidlandsSkyDome";function Go(o,e,t={}){e.toneMapping=oo,e.toneMappingExposure=t.exposure??1.08;const n=t.preset??"terrain",i=fo(t.cloudDetail,"low"),a=xo(t.sunDetail,"low"),s=Math.max(100,Number(t.worldSize)||4500),r=So(n);r.mapping=T,r.colorSpace=b,r.needsUpdate=!0;const m=new R(e),D=m.fromEquirectangular(r).texture;m.dispose();const p=o.userData[M];p&&(o.remove(p),p.geometry.dispose(),p.material.dispose());const y=Do(n,i,a,s);o.add(y),o.userData[M]=y,o.background=new c(264210),o.backgroundIntensity=t.backgroundIntensity??(n==="editor"?.82:.96),o.environment=D,o.environmentIntensity=t.environmentIntensity??(n==="editor"?.72:.9),wo(o,{sunDirection:new u(.5,.78,.36).normalize(),sunColor:n==="editor"?new c(16761978):new c(16773583),sunIntensity:n==="editor"?1.78:1.58,cloudCoverage:n==="editor"?.24:.22,timeSeconds:0}),t.skyboxUrl&&mo(t.skyboxUrl).then(f=>{f.mapping=T,f.colorSpace=b,f.needsUpdate=!0;const C=new R(e),v=C.fromEquirectangular(f).texture;C.dispose(),o.background=f,o.environment=v},()=>{})}function wo(o,e){const t=o.userData[M],i=t?.material?.uniforms;if(!t||!i)return;e.cameraPosition&&t.position.copy(e.cameraPosition);const a=e.sunDirection.clone().normalize(),s=l.clamp(a.y,-.32,.92),r=l.smoothstep(s,-.08,.5),m=l.smoothstep(s,-.2,-.04)*(1-l.smoothstep(s,.3,.56)),D=e.cloudCoverage===null||e.cloudCoverage===void 0?0:Number(e.cloudCoverage),p=yo(D),y=l.clamp(h(e.cloudOpacity,1),0,1),f=p,C=l.clamp(h(e.atmosphereRayleigh,.25),0,4),v=l.clamp(h(e.atmosphereMie,1.55),0,4),S=l.clamp(h(e.atmosphereBrightness,.95),.05,3),A=l.clamp(h(e.atmosphereContrast,.65),.05,3),g=l.clamp(h(e.atmosphereDirectionality,.75),0,1),x=l.clamp(h(e.fogIntensity,0),0,1),P=l.clamp(h(e.rainIntensity,0),0,1),k=Number(e.sunIntensity),K=l.smoothstep(s,-.055,.018)*l.clamp((Number.isFinite(k)?k:0)/1.7,.18,1.2)*l.lerp(.72,1.28,g)*l.lerp(1,.54,Math.max(x*.65,P*.42)),L=e.sunColor.clone().lerp(new c(16761228),l.lerp(.38,.64,l.clamp(v/4,0,1))),J=new c(462876).lerp(new c(7911142),r).lerp(new c(5327720),m*.32).lerp(new c(5208245),l.clamp(C/4,0,1)*r*.18).multiplyScalar(l.lerp(.72,1.18,S/1.4)),Y=new c(1254195).lerp(new c(14151156),r).lerp(L,m*.22).lerp(new c(16757391),l.clamp(v/4,0,1)*m*.3).lerp(new c(15895416),m*l.clamp(v/4,0,1)*.08).multiplyScalar(l.lerp(.72,1.2,S/1.4)),Q=new c(329740).lerp(new c(5991794),r).lerp(L,m*.22).multiplyScalar(l.lerp(.78,1.12,A/1.4));i.uZenithColor.value.copy(J),i.uHorizonColor.value.copy(Y),i.uGroundColor.value.copy(Q),i.uSunColor.value.copy(e.sunColor),i.uSunDirection.value.copy(a),i.uDaylight.value=r,i.uCloudCoverage.value=f,i.uCloudPhase.value=Number(e.timeSeconds)||0,i.uSunVisibility.value=K,i.uCloudOpacity.value=y,i.uCloudSize.value=l.clamp(h(e.cloudSize,3.35),.2,8),i.uCloudColoring.value=l.clamp(h(e.cloudColoring,.65),0,1),i.uCloudSharpness.value=l.clamp(h(e.cloudSharpness,1),0,1),i.uCloudAttenuation.value=l.clamp(h(e.cloudAttenuation,.25),0,1),i.uCloudScattering.value=l.clamp(h(e.cloudScattering,.65),0,1),i.uCloudBrightness.value=l.clamp(h(e.cloudBrightness,.55),0,2),i.uAtmosphereRayleigh.value=C,i.uAtmosphereMie.value=v,i.uAtmosphereDirectionality.value=g,i.uRainbowIntensity.value=l.clamp(h(e.rainbowIntensity,0),0,1),i.uFogIntensity.value=x,i.uRainIntensity.value=P,i.uCameraPosition.value.copy(e.cameraPosition||t.position)}function h(o,e){const t=Number(o);return Number.isFinite(t)?t:e}function Do(o,e,t,n){const i=vo(e),a=go(t),s=new eo({defines:{RAIDLANDS_CLOUD_DETAIL:i.useVolumetricClouds?e==="max"?2:1:0,RAIDLANDS_CLOUD_VIEW_SAMPLES:Math.max(1,i.viewSamples),RAIDLANDS_CLOUD_LIGHT_SAMPLES:Math.max(1,i.lightSamples),RAIDLANDS_SUN_DETAIL:a.shaderLevel},uniforms:{uZenithColor:{value:new c(o==="editor"?1385786:7911142)},uHorizonColor:{value:new c(o==="editor"?8035241:14151156)},uGroundColor:{value:new c(o==="editor"?2168851:5991794)},uSunColor:{value:new c(o==="editor"?16761978:16773583)},uSunDirection:{value:new u(.5,.78,.36).normalize()},uDaylight:{value:1},uCloudCoverage:{value:o==="editor"?.24:.32},uCloudPhase:{value:0},uSunVisibility:{value:1},uCloudOpacity:{value:1},uCloudSize:{value:3.35},uCloudColoring:{value:.65},uCloudSharpness:{value:1},uCloudAttenuation:{value:.25},uCloudScattering:{value:.65},uCloudBrightness:{value:.55},uAtmosphereRayleigh:{value:.25},uAtmosphereMie:{value:1.55},uAtmosphereDirectionality:{value:.75},uRainbowIntensity:{value:0},uFogIntensity:{value:0},uRainIntensity:{value:0},uCameraPosition:{value:new u},uWorldSize:{value:n}},vertexShader:`
    ...
    `,side:to,depthWrite:!1,depthTest:!1,fog:!1});s.customProgramCacheKey=()=>`raidlands-sky-cloud-${e}-sun-${t}-v4`;const r=new w(new F(9e3,48,24),s);return r.name="raidlands-dynamic-sky-dome",r.renderOrder=-1e3,r.frustumCulled=!1,r.userData[M]=s,r}function So(o){return ho(`raidlands-sky:${o}`,()=>{const e=document.createElement("canvas");e.width=1024,e.height=512;const t=e.getContext("2d");if(!t){const s=new V(e);return s.colorSpace=io,s}const n=o==="editor"?{zenith:new c(1120288),horizon:new c(6122352),ground:new c(2168851),sun:new c(16761466)}:{zenith:new c(7911142),horizon:new c(14151156),ground:new c(5991794),sun:new c(16773583)},i=t.createImageData(e.width,e.height);for(let s=0;s<e.height;s+=1){const r=s/(e.height-1),m=1-Math.abs(r*2-1),D=r<.54?n.zenith.clone().lerp(n.horizon,Math.pow(r/.54,.72)):n.horizon.clone().lerp(n.ground,Math.pow((r-.54)/.46,.86));for(let p=0;p<e.width;p+=1){const y=p/(e.width-1),f=Math.hypot((y-.72)*1.55,(r-.46)*2.05),C=Math.hypot((y-.74)*2.8,(r-.58)*4.2),v=Math.max(0,1-f)**2.85,S=Math.max(0,1-C)**2.4,A=Math.max(0,m)**1.72*(o==="editor"?.085:.028),g=D.clone().lerp(n.sun,v*(o==="editor"?.58:.42)+S*(o==="editor"?.18:.12)).offsetHSL(-.012,-.025,A),x=(s*e.width+p)*4;i.data[x]=Math.round(g.r*255),i.data[x+1]=Math.round(g.g*255),i.data[x+2]=Math.round(g.b*255),i.data[x+3]=255}}t.putImageData(i,0,0);const a=new V(e);return a.colorSpace=b,a})}function bo(o){const e=new Map,t=new Map,n=o.clone();return j(o,n,function(i,a){e.set(a,i),t.set(i,a)}),n.traverse(function(i){if(!i.isSkinnedMesh)return;const a=i,s=e.get(i),r=s.skeleton.bones;a.skeleton=s.skeleton.clone(),a.bindMatrix.copy(s.bindMatrix),a.skeleton.bones=r.map(function(m){return t.get(m)}),a.bind(a.skeleton,a.bindMatrix)}),n}function j(o,e,t){t(o,e);for(let n=0;n<o.children.length;n++)j(o.children[n],e.children[n],t)}const _=new Map,Mo=new URL("../../../media/models/draco/",import.meta.url).href,q=new so;q.setDecoderPath(Mo);const z=new co;z.setDRACOLoader(q);z.setMeshoptDecoder(uo);const Ao={vehicle:"f15",modelUrl:"/assets/airstrike-animation-editor/models/f15/scene.gltf",prefabLabel:"assets/scripts/entity/misc/f15/f15e.prefab",scale:185e-8,positionCorrection:{x:0,y:0,z:0},rotationCorrection:{x:0,y:0,z:0},bounds:{x:13,y:5.5,z:19.5},proxy:"plane",hardpoints:[{id:"left_rocket",x:-3.1,y:-.7,z:.8},{id:"right_rocket",x:3.1,y:-.7,z:.8}]};function Wo(o,e){return o?.vehicles?.[e]??o?.vehicles?.f15??Ao}function zo(o,e){const t=o.trim();if(!t)return"";if(/^(https?:)?\/\//i.test(t)||t.startsWith("data:")||t.startsWith("blob:"))return t;const n=e.endsWith("/")?e:`${e}/`;return t.startsWith("/assets/")?`${n}${t.slice(8)}`:t.startsWith("assets/")?`${n}${t.slice(7)}`:t}function I(o,e=.72){return new ro({color:o,metalness:.18,roughness:e})}function d(o,e,t,n,i){const a=new w(new lo(t[0],t[1],t[2]),I(i));return a.name=e,a.position.copy(n),o.add(a),a}function Io(o,e){const t=new U({color:16765286}),n=new F(Math.max(.12,Math.min(e.bounds.x,e.bounds.z)*.018),12,8);for(const i of e.hardpoints){const a=new w(n,t);a.name=`hardpoint:${i.id}`,a.position.copy(H({x:i.x,y:i.y,z:i.z})),o.add(a)}}function Po(o){const e=new ao(o,7268351);e.name="vehicle-bounds",o.add(e)}function ko(o){o.updateMatrixWorld(!0);const e=new W().setFromObject(o);if(e.isEmpty())return;const t=new u;e.getCenter(t),o.position.sub(t)}function Z(o){o.traverse(e=>{e.userData.preserveSharedVehicleAsset=!0})}async function Lo(o){let e=_.get(o);return e||(e=z.loadAsync(o).then(t=>(ko(t.scene),Z(t.scene),t.scene)),_.set(o,e)),e}function To(o,e=.5){o.updateMatrixWorld(!0);const t=new W().setFromObject(o);if(t.isEmpty())return;const n=Math.min(1,Math.max(0,Number.isFinite(e)?e:.5)),i=t.min.y+(t.max.y-t.min.y)*n;o.position.y-=i}function Ro(o,e){const t=e.bounds.x,n=e.bounds.y,i=e.bounds.z;d(o,"fuselage",[Math.max(t*.12,.55),Math.max(n*.34,.35),i],new u(0,0,0),7044229),d(o,"wings",[t,Math.max(n*.08,.15),Math.max(i*.16,.8)],new u(0,0,-i*.08),9216941),d(o,"tail-wing",[t*.45,Math.max(n*.07,.12),Math.max(i*.11,.5)],new u(0,n*.04,i*.42),9216941),d(o,"tail-fin",[Math.max(t*.055,.15),n*.48,Math.max(i*.11,.45)],new u(0,n*.28,i*.42),7374736);const a=new w(new G(Math.max(t*.08,.32),Math.max(i*.16,.75),18),I(14674412,.55));a.name="nose-direction",a.rotation.x=-Math.PI/2,a.position.z=-i*.58,o.add(a)}function Vo(o,e){const t=Math.max(e.bounds.x,1.2),n=Math.max(e.bounds.y,.5);d(o,"drone-body",[t*.42,n*.45,t*.42],new u(0,0,0),7044229),d(o,"drone-arm-x",[t*1.15,n*.08,t*.08],new u(0,0,0),10268599),d(o,"drone-arm-z",[t*.08,n*.08,t*1.15],new u(0,0,0),10268599);const i=new U({color:13363438,transparent:!0,opacity:.42}),a=new no(t*.18,22);for(const s of[-t*.48,t*.48])for(const r of[-t*.48,t*.48]){const m=new w(a,i);m.name="rotor-disc",m.rotation.x=-Math.PI/2,m.position.set(s,n*.08,r),o.add(m)}}function Eo(o,e){const t=e.bounds.x,n=e.bounds.y,i=e.bounds.z;d(o,"heli-body",[Math.max(t*.24,1.8),Math.max(n*.38,1),Math.max(i*.33,2.8)],new u(0,0,-i*.08),7636107),d(o,"heli-tail",[Math.max(t*.09,.55),Math.max(n*.12,.32),i*.5],new u(0,n*.08,i*.28),9216941),d(o,"heli-tail-rotor",[t*.24,Math.max(n*.06,.16),Math.max(i*.04,.2)],new u(0,n*.16,i*.55),13363438),d(o,"heli-main-rotor-a",[t*.9,Math.max(n*.035,.12),Math.max(i*.035,.12)],new u(0,n*.46,-i*.09),13363438),d(o,"heli-main-rotor-b",[Math.max(t*.035,.12),Math.max(n*.035,.12),i*.55],new u(0,n*.46,-i*.09),13363438);const a=new w(new G(Math.max(t*.08,.4),Math.max(i*.12,.8),18),I(14674412,.55));a.name="heli-nose-direction",a.rotation.x=-Math.PI/2,a.position.z=-i*.33,o.add(a)}function Bo(o,e){const t=Math.max(e.bounds.x,2.8),n=Math.max(e.bounds.y,1.8),i=Math.max(e.bounds.z,4.8),a=3160378;d(o,"ground-hull",[t*.72,n*.4,i*.68],new u(0,n*.04,0),6647914),d(o,"ground-tread-left",[t*.22,n*.28,i*.88],new u(-t*.37,-n*.1,0),a),d(o,"ground-tread-right",[t*.22,n*.28,i*.88],new u(t*.37,-n*.1,0),a),d(o,"ground-turret",[t*.42,n*.25,i*.28],new u(0,n*.3,-i*.04),7832184),d(o,"ground-barrel",[Math.max(t*.08,.18),Math.max(n*.08,.16),i*.5],new u(0,n*.32,-i*.34),3884355)}function _o(o,e){const t=Math.max(e.bounds.x,18),n=Math.max(e.bounds.y,12),i=Math.max(e.bounds.z,72);d(o,"ship-hull",[t,n*.34,i],new u(0,-n*.08,0),5070177),d(o,"ship-deck",[t*.88,n*.08,i*.82],new u(0,n*.14,0),7962752),d(o,"ship-bridge",[t*.45,n*.36,i*.2],new u(0,n*.36,-i*.2),8358793),d(o,"ship-stack",[t*.18,n*.46,i*.12],new u(0,n*.46,i*.2),3422267)}function O(o,e={}){const t=new N;t.name=`vehicle-proxy:${o.vehicle}`;const n=o.proxy??(o.vehicle==="drone"?"drone":o.vehicle==="attack_heli"||o.vehicle==="chinook"?"helicopter":o.vehicle==="bradley"?"ground":o.vehicle==="cargo_ship"?"ship":"plane");return n==="drone"?Vo(t,o):n==="helicopter"?Eo(t,o):n==="ground"?Bo(t,o):n==="ship"?_o(t,o):Ro(t,o),Io(t,o),e.showBounds&&Po(t),t.rotation.set(o.rotationCorrection.x*Math.PI/180,o.rotationCorrection.y*Math.PI/180,o.rotationCorrection.z*Math.PI/180),t}async function Ho(o,e){const t=zo(o.modelUrl,e);if(!t)return{object:O(o),usedFallback:!0,resolvedUrl:t};try{const n=await Lo(t),i=new N;i.name=`vehicle-glb:${o.vehicle}`;const a=bo(n);Z(a),i.add(a),i.scale.setScalar(o.scale||1),i.rotation.set(o.rotationCorrection.x*Math.PI/180,o.rotationCorrection.y*Math.PI/180,o.rotationCorrection.z*Math.PI/180),To(i,o.visualOriginY);const s=H(o.positionCorrection);return i.position.add(s),{object:i,usedFallback:!1,resolvedUrl:t}}catch{return{object:O(o),usedFallback:!0,resolvedUrl:t}}}export{Go as a,Ho as b,O as c,xo as d,go as e,ho as g,Uo as i,mo as l,Wo as m,fo as p,vo as r,wo as u};
//# sourceMappingURL=vehicle-preview-CYcUESCE.js.map
