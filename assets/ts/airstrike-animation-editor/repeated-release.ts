...
export function hasGroupedRepeatedReleases(release: RepeatedReleaseSource): boolean {
 ...
 */
export function repeatedReleaseGroups(release: RepeatedReleaseSource): RepeatedReleaseGroup[] {
