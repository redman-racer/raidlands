...
<section class="section">
  <div class="section-inner split-panel">
    <div class="metal-panel">
      ...
      <p class="section-lede">Discord is the active home for alerts, teammates, support, bug reports, feature votes, event announcements, and ban appeals.</p>
      <ul class="list-clean">
        ...
        <li>Vote on events, systems, and server direction.</li>
      </ul>
