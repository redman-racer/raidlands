import{a2 as J,l as b,$ as Q,al as R,am as T,o as r,V as c,ag as ee,an as oe,b as S,S as F,n as l,s as V,ao as te,G as U,M as B,ap as ie,k as W,aq as ne,f as q,B as ae,g as le}from"./three.module-B3wciJAI.js";import{D as re,G as se}from"./GLTFLoader-DuXpmKSc.js";import{M as ce}from"./meshopt_decoder.module-BlX9U5HT.js";import{c as ue}from"./SkeletonUtils-BCVmgslc.js";import{u as G}from"./coordinates-rE8UQ_IQ.js";const _=new Map,O=new Map;function H(e){return e.userData.preserveSharedAsset=!0,e}function qe(e){return!!(e&&typeof e=="object"&&e.userData?.preserveSharedAsset===!0)}async function de(e){let o=_.get(e);return o||(o=new J().loadAsync(e).then(t=>H(t)),_.set(e,o)),o}function me(e,o){const t=O.get(e);if(t)return t;const n=H(o());return n.colorSpace=n.colorSpace||b,O.set(e,n),n}const he={low:{detail:"low",viewSamples:0,lightSamples:0,shadowOctaves:0,useVolumetricClouds:!1,useSpriteClouds:!0},medium:{detail:"medium",viewSamples:32,lightSamples:2,shadowOctaves:2,useVolumetricClouds:!0,useSpriteClouds:!1},max:{detail:"max",viewSamples:56,lightSamples:4,shadowOctaves:4,useVolumetricClouds:!0,useSpriteClouds:!1}};function pe(e,o="low"){return e==="low"||e==="medium"||e==="max"?e:o}function fe(e){return he[e]}function ve(e){const o=Number(e);return Number.isFinite(o)?Math.min(1,Math.max(0,o)):0}const ge={low:{detail:"low",shaderLevel:0,useAtmosphericDisc:!1,useCinematicOptics:!1,lightingResponse:0},medium:{detail:"medium",shaderLevel:1,useAtmosphericDisc:!0,useCinematicOptics:!1,lightingResponse:.55},max:{detail:"max",shaderLevel:2,useAtmosphericDisc:!0,useCinematicOptics:!0,lightingResponse:1}};function ye(e,o="low"){return e==="low"||e==="medium"||e==="max"?e:o}function Ce(e){return ge[e]}const De=.42;function Se(e){const o=e.clone().normalize();return Math.atan2(o.y,-o.x/De)}const A="raidlandsSkyDome";function Ge(e,o,t={}){o.toneMapping=Q,o.toneMappingExposure=t.exposure??1.08;const n=t.preset??"terrain",i=pe(t.cloudDetail,"low"),a=ye(t.sunDetail,"low"),u=Math.max(100,Number(t.worldSize)||4500),s=be(n);s.mapping=R,s.colorSpace=b,s.needsUpdate=!0;const m=new T(o),x=m.fromEquirectangular(s).texture;m.dispose();const p=e.userData[A];p&&(e.remove(p),p.geometry.dispose(),p.material.dispose());const g=we(n,i,a,u);e.add(g),e.userData[A]=g,e.background=new r(264210),e.backgroundIntensity=t.backgroundIntensity??(n==="editor"?.82:.96),e.environment=x,e.environmentIntensity=t.environmentIntensity??(n==="editor"?.72:.9),xe(e,{sunDirection:new c(.5,.78,.36).normalize(),sunColor:n==="editor"?new r(16761978):new r(16773583),sunIntensity:n==="editor"?1.78:1.58,cloudCoverage:n==="editor"?.24:.22,timeSeconds:0}),t.skyboxUrl&&de(t.skyboxUrl).then(f=>{f.mapping=R,f.colorSpace=b,f.needsUpdate=!0;const y=new T(o),v=y.fromEquirectangular(f).texture;y.dispose(),e.background=f,e.environment=v},()=>{})}function xe(e,o){const t=e.userData[A],i=t?.material?.uniforms;if(!t||!i)return;o.cameraPosition&&t.position.copy(o.cameraPosition);const a=o.sunDirection.clone().normalize(),u=l.clamp(a.y,-.32,.92),s=l.smoothstep(u,-.08,.5),m=l.smoothstep(u,-.2,-.04)*(1-l.smoothstep(u,.3,.56)),x=o.cloudCoverage===null||o.cloudCoverage===void 0?0:Number(o.cloudCoverage),p=ve(x),g=l.clamp(h(o.cloudOpacity,1),0,1),f=p,y=l.clamp(h(o.atmosphereRayleigh,.25),0,4),v=l.clamp(h(o.atmosphereMie,1.55),0,4),w=l.clamp(h(o.atmosphereBrightness,.95),.05,3),z=l.clamp(h(o.atmosphereContrast,.65),.05,3),D=l.clamp(h(o.atmosphereDirectionality,.75),0,1),C=l.clamp(h(o.fogIntensity,0),0,1),I=l.clamp(h(o.rainIntensity,0),0,1),P=Number(o.sunIntensity),Z=l.smoothstep(u,-.055,.018)*l.clamp((Number.isFinite(P)?P:0)/1.7,.18,1.2)*l.lerp(.72,1.28,D)*l.lerp(1,.54,Math.max(C*.65,I*.42)),L=o.sunColor.clone().lerp(new r(16761228),l.lerp(.38,.64,l.clamp(v/4,0,1))),X=new r(462876).lerp(new r(7911142),s).lerp(new r(5327720),m*.32).lerp(new r(5208245),l.clamp(y/4,0,1)*s*.18).multiplyScalar(l.lerp(.72,1.18,w/1.4)),K=new r(1254195).lerp(new r(14151156),s).lerp(L,m*.22).lerp(new r(16757391),l.clamp(v/4,0,1)*m*.3).lerp(new r(15895416),m*l.clamp(v/4,0,1)*.08).multiplyScalar(l.lerp(.72,1.2,w/1.4)),Y=new r(329740).lerp(new r(5991794),s).lerp(L,m*.22).multiplyScalar(l.lerp(.78,1.12,z/1.4));i.uZenithColor.value.copy(X),i.uHorizonColor.value.copy(K),i.uGroundColor.value.copy(Y),i.uSunColor.value.copy(o.sunColor),i.uSunDirection.value.copy(a),i.uCelestialAngle.value=Se(a),i.uDaylight.value=s,i.uCloudCoverage.value=f,i.uCloudPhase.value=Number(o.timeSeconds)||0,i.uSunVisibility.value=Z,i.uCloudOpacity.value=g,i.uCloudSize.value=l.clamp(h(o.cloudSize,3.35),.2,8),i.uCloudColoring.value=l.clamp(h(o.cloudColoring,.65),0,1),i.uCloudSharpness.value=l.clamp(h(o.cloudSharpness,1),0,1),i.uCloudAttenuation.value=l.clamp(h(o.cloudAttenuation,.25),0,1),i.uCloudScattering.value=l.clamp(h(o.cloudScattering,.65),0,1),i.uCloudBrightness.value=l.clamp(h(o.cloudBrightness,.55),0,2),i.uAtmosphereRayleigh.value=y,i.uAtmosphereMie.value=v,i.uAtmosphereDirectionality.value=D,i.uRainbowIntensity.value=l.clamp(h(o.rainbowIntensity,0),0,1),i.uFogIntensity.value=C,i.uRainIntensity.value=I,i.uCameraPosition.value.copy(o.cameraPosition||t.position)}function h(e,o){const t=Number(e);return Number.isFinite(t)?t:o}function we(e,o,t,n){const i=fe(o),a=Ce(t),u=new ee({defines:{RAIDLANDS_CLOUD_DETAIL:i.useVolumetricClouds?o==="max"?2:1:0,RAIDLANDS_CLOUD_VIEW_SAMPLES:Math.max(1,i.viewSamples),RAIDLANDS_CLOUD_LIGHT_SAMPLES:Math.max(1,i.lightSamples),RAIDLANDS_SUN_DETAIL:a.shaderLevel},uniforms:{uZenithColor:{value:new r(e==="editor"?1385786:7911142)},uHorizonColor:{value:new r(e==="editor"?8035241:14151156)},uGroundColor:{value:new r(e==="editor"?2168851:5991794)},uSunColor:{value:new r(e==="editor"?16761978:16773583)},uSunDirection:{value:new c(.5,.78,.36).normalize()},uCelestialAngle:{value:0},uDaylight:{value:1},uCloudCoverage:{value:e==="editor"?.24:.32},uCloudPhase:{value:0},uSunVisibility:{value:1},uCloudOpacity:{value:1},uCloudSize:{value:3.35},uCloudColoring:{value:.65},uCloudSharpness:{value:1},uCloudAttenuation:{value:.25},uCloudScattering:{value:.65},uCloudBrightness:{value:.55},uAtmosphereRayleigh:{value:.25},uAtmosphereMie:{value:1.55},uAtmosphereDirectionality:{value:.75},uRainbowIntensity:{value:0},uFogIntensity:{value:0},uRainIntensity:{value:0},uCameraPosition:{value:new c},uWorldSize:{value:n}},vertexShader:`
    ...
    `,side:oe,depthWrite:!1,depthTest:!1,fog:!1});u.customProgramCacheKey=()=>`raidlands-sky-cloud-${o}-sun-${t}-v6`;const s=new S(new F(9e3,48,24),u);return s.name="raidlands-dynamic-sky-dome",s.renderOrder=-1e3,s.frustumCulled=!1,s.userData[A]=u,s}function be(e){return me(`raidlands-sky:${e}`,()=>{const o=document.createElement("canvas");o.width=1024,o.height=512;const t=o.getContext("2d");if(!t){const u=new V(o);return u.colorSpace=te,u}const n=e==="editor"?{zenith:new r(1120288),horizon:new r(6122352),ground:new r(2168851),sun:new r(16761466)}:{zenith:new r(7911142),horizon:new r(14151156),ground:new r(5991794),sun:new r(16773583)},i=t.createImageData(o.width,o.height);for(let u=0;u<o.height;u+=1){const s=u/(o.height-1),m=1-Math.abs(s*2-1),x=s<.54?n.zenith.clone().lerp(n.horizon,Math.pow(s/.54,.72)):n.horizon.clone().lerp(n.ground,Math.pow((s-.54)/.46,.86));for(let p=0;p<o.width;p+=1){const g=p/(o.width-1),f=Math.hypot((g-.72)*1.55,(s-.46)*2.05),y=Math.hypot((g-.74)*2.8,(s-.58)*4.2),v=Math.max(0,1-f)**2.85,w=Math.max(0,1-y)**2.4,z=Math.max(0,m)**1.72*(e==="editor"?.085:.028),D=x.clone().lerp(n.sun,v*(e==="editor"?.58:.42)+w*(e==="editor"?.18:.12)).offsetHSL(-.012,-.025,z),C=(u*o.width+p)*4;i.data[C]=Math.round(D.r*255),i.data[C+1]=Math.round(D.g*255),i.data[C+2]=Math.round(D.b*255),i.data[C+3]=255}}t.putImageData(i,0,0);const a=new V(o);return a.colorSpace=b,a})}const E=new Map,Ae=new URL("../../../media/models/draco/",import.meta.url).href,$=new re;$.setDecoderPath(Ae);const M=new se;M.setDRACOLoader($);M.setMeshoptDecoder(ce);const ze={vehicle:"f15",modelUrl:"/assets/airstrike-animation-editor/models/f15/scene.gltf",prefabLabel:"assets/scripts/entity/misc/f15/f15e.prefab",scale:185e-8,positionCorrection:{x:0,y:0,z:0},rotationCorrection:{x:0,y:0,z:0},bounds:{x:13,y:5.5,z:19.5},proxy:"plane",hardpoints:[{id:"left_rocket",x:-3.1,y:-.7,z:.8},{id:"right_rocket",x:3.1,y:-.7,z:.8}]};function He(e,o){return e?.vehicles?.[o]??e?.vehicles?.f15??ze}function Me(e,o){const t=e.trim();if(!t)return"";if(/^(https?:)?\/\//i.test(t)||t.startsWith("data:")||t.startsWith("blob:"))return t;const n=o.endsWith("/")?o:`${o}/`;return t.startsWith("/assets/")?`${n}${t.slice(8)}`:t.startsWith("assets/")?`${n}${t.slice(7)}`:t}function k(e,o=.72){return new le({color:e,metalness:.18,roughness:o})}function d(e,o,t,n,i){const a=new S(new ae(t[0],t[1],t[2]),k(i));return a.name=o,a.position.copy(n),e.add(a),a}function ke(e,o){const t=new B({color:16765286}),n=new F(Math.max(.12,Math.min(o.bounds.x,o.bounds.z)*.018),12,8);for(const i of o.hardpoints){const a=new S(n,t);a.name=`hardpoint:${i.id}`,a.position.copy(G({x:i.x,y:i.y,z:i.z})),e.add(a)}}function Ie(e){const o=new ne(e,7268351);o.name="vehicle-bounds",e.add(o)}function Pe(e){e.updateMatrixWorld(!0);const o=new q().setFromObject(e);if(o.isEmpty())return;const t=new c;o.getCenter(t),e.position.sub(t)}function j(e){e.traverse(o=>{o.userData.preserveSharedVehicleAsset=!0})}async function Le(e){let o=E.get(e);return o||(o=M.loadAsync(e).then(t=>(Pe(t.scene),j(t.scene),t.scene)),E.set(e,o)),o}function Re(e,o=.5){e.updateMatrixWorld(!0);const t=new q().setFromObject(e);if(t.isEmpty())return;const n=Math.min(1,Math.max(0,Number.isFinite(o)?o:.5)),i=t.min.y+(t.max.y-t.min.y)*n;e.position.y-=i}function Te(e,o){const t=o.bounds.x,n=o.bounds.y,i=o.bounds.z;d(e,"fuselage",[Math.max(t*.12,.55),Math.max(n*.34,.35),i],new c(0,0,0),7044229),d(e,"wings",[t,Math.max(n*.08,.15),Math.max(i*.16,.8)],new c(0,0,-i*.08),9216941),d(e,"tail-wing",[t*.45,Math.max(n*.07,.12),Math.max(i*.11,.5)],new c(0,n*.04,i*.42),9216941),d(e,"tail-fin",[Math.max(t*.055,.15),n*.48,Math.max(i*.11,.45)],new c(0,n*.28,i*.42),7374736);const a=new S(new W(Math.max(t*.08,.32),Math.max(i*.16,.75),18),k(14674412,.55));a.name="nose-direction",a.rotation.x=-Math.PI/2,a.position.z=-i*.58,e.add(a)}function Ve(e,o){const t=Math.max(o.bounds.x,1.2),n=Math.max(o.bounds.y,.5);d(e,"drone-body",[t*.42,n*.45,t*.42],new c(0,0,0),7044229),d(e,"drone-arm-x",[t*1.15,n*.08,t*.08],new c(0,0,0),10268599),d(e,"drone-arm-z",[t*.08,n*.08,t*1.15],new c(0,0,0),10268599);const i=new B({color:13363438,transparent:!0,opacity:.42}),a=new ie(t*.18,22);for(const u of[-t*.48,t*.48])for(const s of[-t*.48,t*.48]){const m=new S(a,i);m.name="rotor-disc",m.rotation.x=-Math.PI/2,m.position.set(u,n*.08,s),e.add(m)}}function _e(e,o){const t=o.bounds.x,n=o.bounds.y,i=o.bounds.z;d(e,"heli-body",[Math.max(t*.24,1.8),Math.max(n*.38,1),Math.max(i*.33,2.8)],new c(0,0,-i*.08),7636107),d(e,"heli-tail",[Math.max(t*.09,.55),Math.max(n*.12,.32),i*.5],new c(0,n*.08,i*.28),9216941),d(e,"heli-tail-rotor",[t*.24,Math.max(n*.06,.16),Math.max(i*.04,.2)],new c(0,n*.16,i*.55),13363438),d(e,"heli-main-rotor-a",[t*.9,Math.max(n*.035,.12),Math.max(i*.035,.12)],new c(0,n*.46,-i*.09),13363438),d(e,"heli-main-rotor-b",[Math.max(t*.035,.12),Math.max(n*.035,.12),i*.55],new c(0,n*.46,-i*.09),13363438);const a=new S(new W(Math.max(t*.08,.4),Math.max(i*.12,.8),18),k(14674412,.55));a.name="heli-nose-direction",a.rotation.x=-Math.PI/2,a.position.z=-i*.33,e.add(a)}function Oe(e,o){const t=Math.max(o.bounds.x,2.8),n=Math.max(o.bounds.y,1.8),i=Math.max(o.bounds.z,4.8),a=3160378;d(e,"ground-hull",[t*.72,n*.4,i*.68],new c(0,n*.04,0),6647914),d(e,"ground-tread-left",[t*.22,n*.28,i*.88],new c(-t*.37,-n*.1,0),a),d(e,"ground-tread-right",[t*.22,n*.28,i*.88],new c(t*.37,-n*.1,0),a),d(e,"ground-turret",[t*.42,n*.25,i*.28],new c(0,n*.3,-i*.04),7832184),d(e,"ground-barrel",[Math.max(t*.08,.18),Math.max(n*.08,.16),i*.5],new c(0,n*.32,-i*.34),3884355)}function Ee(e,o){const t=Math.max(o.bounds.x,18),n=Math.max(o.bounds.y,12),i=Math.max(o.bounds.z,72);d(e,"ship-hull",[t,n*.34,i],new c(0,-n*.08,0),5070177),d(e,"ship-deck",[t*.88,n*.08,i*.82],new c(0,n*.14,0),7962752),d(e,"ship-bridge",[t*.45,n*.36,i*.2],new c(0,n*.36,-i*.2),8358793),d(e,"ship-stack",[t*.18,n*.46,i*.12],new c(0,n*.46,i*.2),3422267)}function N(e,o={}){const t=new U;t.name=`vehicle-proxy:${e.vehicle}`;const n=e.proxy??(e.vehicle==="drone"?"drone":e.vehicle==="attack_heli"||e.vehicle==="chinook"?"helicopter":e.vehicle==="bradley"?"ground":e.vehicle==="cargo_ship"?"ship":"plane");return n==="drone"?Ve(t,e):n==="helicopter"?_e(t,e):n==="ground"?Oe(t,e):n==="ship"?Ee(t,e):Te(t,e),ke(t,e),o.showBounds&&Ie(t),t.rotation.set(e.rotationCorrection.x*Math.PI/180,e.rotationCorrection.y*Math.PI/180,e.rotationCorrection.z*Math.PI/180),t}async function $e(e,o){const t=Me(e.modelUrl,o);if(!t)return{object:N(e),usedFallback:!0,resolvedUrl:t};try{const n=await Le(t),i=new U;i.name=`vehicle-glb:${e.vehicle}`;const a=ue(n);j(a),i.add(a),i.scale.setScalar(e.scale||1),i.rotation.set(e.rotationCorrection.x*Math.PI/180,e.rotationCorrection.y*Math.PI/180,e.rotationCorrection.z*Math.PI/180),Re(i,e.visualOriginY);const u=G(e.positionCorrection);return i.position.add(u),{object:i,usedFallback:!1,resolvedUrl:t}}catch{return{object:N(e),usedFallback:!0,resolvedUrl:t}}}export{Ge as a,$e as b,N as c,ye as d,Ce as e,me as g,qe as i,de as l,He as m,pe as p,fe as r,xe as u};
//# sourceMappingURL=vehicle-preview-BPVr6o3a.js.map
