...
describe("monument quality policy", () => {
  ...
  it("applies the requested tier caps and total resource budgets", () => {
    expect(resolveMonumentQuality("auto", "low")).toMatchObject({ activeCloseLimit: 1, activeMidLimit: 4, activeMapLimit: 24, triangleBudget: 3_000_000, drawCallBudget: 2_500 });
