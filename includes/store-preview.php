...
function raidlands_store_preview_asset_registry(): array
{
    return [
        ...
        'ammo.grenadelauncher.he' => ['file' => '40mm-grenade-he.glb', 'scale' => 0.85, 'category' => 'ammo'],
        'ammo.rifle.hv' => ['file' => 'rifle-ammo-hv.glb', 'scale' => 0.85, 'category' => 'ammo'],
        'barricade.wood.cover' => ['file' => 'wood-barricade-cover.glb', 'scale' => 0.9, 'category' => 'deployable'],
        'building.planner' => ['file' => 'building-planner.glb', 'scale' => 0.8, 'category' => 'item'],
        'cctv.camera' => ['file' => 'cctv-camera.glb', 'scale' => 0.85, 'category' => 'deployable'],
        'cloth' => ['file' => 'cloth.glb', 'scale' => 0.9, 'category' => 'resource'],
        'diving.fins' => ['file' => 'diving-fins.glb', 'scale' => 0.9, 'category' => 'armor'],
        'diving.mask' => ['file' => 'diving-mask.glb', 'scale' => 0.9, 'category' => 'armor'],
        'diving.tank' => ['file' => 'diving-tank.glb', 'scale' => 0.9, 'category' => 'armor'],
        'diving.wetsuit' => ['file' => 'diving-wetsuit.glb', 'scale' => 0.85, 'category' => 'armor'],
        'flashlight.held' => ['file' => 'held-flashlight.glb', 'scale' => 0.8, 'category' => 'item'],
        'gears' => ['file' => 'gears.glb', 'scale' => 0.85, 'category' => 'resource'],
        'grenade.smoke' => ['file' => 'smoke-grenade.glb', 'scale' => 0.8, 'category' => 'explosive'],
        'hammer' => ['file' => 'hammer.glb', 'scale' => 0.9, 'category' => 'weapon'],
        'hatchet' => ['file' => 'hatchet.glb', 'scale' => 0.9, 'category' => 'weapon'],
        'jackhammer' => ['file' => 'jackhammer.glb', 'scale' => 0.95, 'category' => 'weapon'],
        'keycard_blue' => ['file' => 'blue-keycard.glb', 'scale' => 0.8, 'category' => 'item'],
        'keycard_green' => ['file' => 'green-keycard.glb', 'scale' => 0.8, 'category' => 'item'],
        'keycard_red' => ['file' => 'red-keycard.glb', 'scale' => 0.8, 'category' => 'item'],
        'metal.fragments' => ['file' => 'metal-fragments.glb', 'scale' => 0.9, 'category' => 'resource'],
        'metal.refined' => ['file' => 'high-quality-metal.glb', 'scale' => 0.9, 'category' => 'resource'],
        'metalblade' => ['file' => 'metal-blade.glb', 'scale' => 0.85, 'category' => 'resource'],
        'metalpipe' => ['file' => 'metal-pipe.glb', 'scale' => 0.85, 'category' => 'resource'],
        'metalspring' => ['file' => 'metal-spring.glb', 'scale' => 0.85, 'category' => 'resource'],
        'roadsigns' => ['file' => 'road-signs.glb', 'scale' => 0.9, 'category' => 'resource'],
        'rope' => ['file' => 'rope.glb', 'scale' => 0.85, 'category' => 'resource'],
        'semibody' => ['file' => 'semi-auto-body.glb', 'scale' => 0.85, 'category' => 'resource'],
        'sewingkit' => ['file' => 'sewing-kit.glb', 'scale' => 0.85, 'category' => 'resource'],
        'sheetmetal' => ['file' => 'sheet-metal.glb', 'scale' => 0.9, 'category' => 'resource'],
        'stones' => ['file' => 'stones.glb', 'scale' => 0.9, 'category' => 'resource'],
        'techparts' => ['file' => 'tech-trash.glb', 'scale' => 0.85, 'category' => 'resource'],
        'weapon.mod.extendedmags' => ['file' => 'extended-magazine.glb', 'scale' => 0.75, 'category' => 'attachment'],
        'weapon.mod.muzzleboost' => ['file' => 'muzzle-boost.glb', 'scale' => 0.75, 'category' => 'attachment'],
        'wood' => ['file' => 'wood.glb', 'scale' => 0.9, 'category' => 'resource'],
        'raidlands.vehicle.token.attack_helicopter' => ['file' => 'attack-helicopter.glb', 'scale' => 1.0, 'category' => 'vehicle'],
        'raidlands.vehicle.token.duo_submarine' => ['file' => 'duo-submarine.glb', 'scale' => 1.0, 'category' => 'vehicle'],
        'raidlands.vehicle.token.hot_air_balloon' => ['file' => 'hot-air-balloon.glb', 'scale' => 1.0, 'category' => 'vehicle'],
        'raidlands.vehicle.token.rhib' => ['file' => 'rhib.glb', 'scale' => 1.0, 'category' => 'vehicle'],
        'raidlands.vehicle.token.scrap_transport_helicopter' => ['file' => 'scrap-transport-helicopter.glb', 'scale' => 1.0, 'category' => 'vehicle'],
        'raidlands.vehicle.token.snowmobile' => ['file' => 'snowmobile.glb', 'scale' => 1.0, 'category' => 'vehicle'],
        'raidlands.vehicle.token.solo_submarine' => ['file' => 'solo-submarine.glb', 'scale' => 1.0, 'category' => 'vehicle'],
        'raidlands.vehicle.token.tugboat' => ['file' => 'tugboat.glb', 'scale' => 1.0, 'category' => 'vehicle'],
    ];
}
