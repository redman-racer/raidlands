...
function raidlands_permissions_fallback_permissions(): array
{
    $permissions = [
        ...
        'guardian.all',
        'guardian.admin',
        'guardian.bypass.anticheat.aim',
        'guardian.bypass.anticheat.firerate',
        'guardian.bypass.anticheat.gravity',
        'guardian.bypass.anticheat.meleerate',
        'guardian.bypass.anticheat.recoil',
        'guardian.bypass.anticheat.server',
        'guardian.bypass.anticheat.stash',
        'guardian.bypass.anticheat.trajectory',
        'guardian.bypass.anticheat.wallhack',
        'guardian.bypass.steam',
        'guardian.bypass.vpn',
    ...
    $permissions = array_merge($permissions, [
        ...
        'autopickupbarrel.barrel.nogibs',
        'autopickupbarrel.barrel.on',
        'autopickupbarrel.roadsign.instakill',
        'autopickupbarrel.roadsign.nogibs',
        ...
        'deathnotes.cansee',
        'deathnotes.cantsee',
        'deathnotes.seeteamonly',
        'deathnotes.suppress',
        'disablecolddamage.use',
        'disabletemperaturefunctions.use',
        'discordwipe.admin',
        'entitylimit.debug',
        'entitylimit.default',
        'entitylimit.nolimit',
        ...
        'nocraft.bypass',
        'noweapondrop.active',
        'nteleportation.blocktpmarker',
        'nteleportation.bypassfoundationcheck',
        'nteleportation.cavehome',
        'nteleportation.cavetpr',
        'nteleportation.crafthome',
        'nteleportation.crafttpr',
        'nteleportation.disallowtptome',
        'nteleportation.exemptfrominterruptcountdown',
        'nteleportation.ignoreglobalcooldown',
        'nteleportation.locationradiusbypass',
        'nteleportation.nocosts',
        'nteleportation.norestrictions',
        'nteleportation.playerboatsinterruptbypass',
        'nteleportation.playerboatssethomebypass',
        'nteleportation.skipwipewaittime',
        'nteleportation.tpa',
        'nteleportation.tpmarker',
        'nteleportation.tpt',
        'nteleportation.tugboatsinterruptbypass',
        'nteleportation.tugboatssethomebypass',
        'nteleportation.vip',
        'privatemessages.allow',
        'raidlands.consumables.admin',
        'raidlands.portaforts.admin',
        'raidlands.vehicletokens.admin',
        'raidlands.vehicletokens.bypass',
        'raidlandsvehicletokens.admin',
        'raidlandsvehicletokens.bypass',
        'raidlandsvehicletokens.vehicle.hp.125',
        'raidlandsvehicletokens.vehicle.hp.150',
        'rocketfire.use',
        'shareddoors.master',
        'signartist.file',
        'signartist.ignorecd',
        ...
        'spawnheli.attackhelicopter.fetch.10m',
        'spawnheli.attackhelicopter.fetch.10s',
        'spawnheli.attackhelicopter.fetch.1hr',
        ...
        'spawnheli.attackhelicopter.spawn.10m',
        'spawnheli.attackhelicopter.spawn.10s',
        'spawnheli.attackhelicopter.spawn.1hr',
        'spawnheli.attackhelicopter.unlimitedfuel',
        'spawnheli.minicopter.automount',
        'spawnheli.minicopter.fetch.10m',
        'spawnheli.minicopter.fetch.10s',
        'spawnheli.minicopter.fetch.1hr',
        ...
        'spawnheli.minicopter.spawn.10m',
        'spawnheli.minicopter.spawn.10s',
        'spawnheli.minicopter.spawn.1hr',
        ...
        'spawnheli.scraptransport.fetch.10m',
        'spawnheli.scraptransport.fetch.10s',
        'spawnheli.scraptransport.fetch.1hr',
        ...
        'spawnheli.scraptransport.spawn.10m',
        'spawnheli.scraptransport.spawn.10s',
        'spawnheli.scraptransport.spawn.1hr',
        'spawnheli.scraptransport.unlimitedfuel',
        'targetabledrones.untargetable',
        'toolcupboardturrets.ignore',
        'toolcupboardturrets.neverignore',
        'trade.accept',
        'trade.use',
        'turretswitches.sam',
        'turretswitches.turret',
        'vehiclelicence.admin',
        'vehiclelicence.all',
        'vehiclelicence.armoredhotairballoon',
        'vehiclelicence.armoredhotairballoonfree',
        'vehiclelicence.attackhelicopter',
        'vehiclelicence.attackhelicopterfree',
        'vehiclelicence.ballista',
        'vehiclelicence.ballistafree',
        'vehiclelicence.batteringram',
        'vehiclelicence.batteringramfree',
        'vehiclelicence.bypasscost',
        'vehiclelicence.catapult',
        'vehiclelicence.catapultfree',
        'vehiclelicence.chinook',
        'vehiclelicence.chinookfree',
        'vehiclelicence.completetrain',
        'vehiclelicence.completetrainfree',
        'vehiclelicence.coveredworkcart',
        'vehiclelicence.coveredworkcartfree',
        'vehiclelicence.dpv',
        'vehiclelicence.dpvfree',
        'vehiclelicence.hotairballoon',
        'vehiclelicence.hotairballoonfree',
        'vehiclelicence.kayak',
        'vehiclelicence.kayakfree',
        'vehiclelicence.largemodularcar',
        'vehiclelicence.largemodularcarfree',
        'vehiclelicence.locomotive',
        'vehiclelicence.locomotivefree',
        'vehiclelicence.magnetcrane',
        'vehiclelicence.magnetcranefree',
        'vehiclelicence.mediumodularcar',
        'vehiclelicence.mediumodularcarfree',
        'vehiclelicence.minicopter',
        'vehiclelicence.minicopterfree',
        'vehiclelicence.motorbike',
        'vehiclelicence.motorbikefree',
        'vehiclelicence.motorbikesidecar',
        'vehiclelicence.motorbikesidecarfree',
        'vehiclelicence.nocollisiondamage',
        'vehiclelicence.nodamage',
        'vehiclelicence.pedalbike',
        'vehiclelicence.pedalbikefree',
        'vehiclelicence.pedaltrike',
        'vehiclelicence.pedaltrikefree',
        'vehiclelicence.ptboat',
        'vehiclelicence.ptboatfree',
        'vehiclelicence.rhib',
        'vehiclelicence.rhibfree',
        'vehiclelicence.ridablehorse',
        'vehiclelicence.ridablehorsefree',
        'vehiclelicence.rowboat',
        'vehiclelicence.rowboatfree',
        'vehiclelicence.sedan',
        'vehiclelicence.sedanfree',
        'vehiclelicence.sedanrail',
        'vehiclelicence.sedanrailfree',
        'vehiclelicence.siegetower',
        'vehiclelicence.siegetowerfree',
        'vehiclelicence.smallmodularcar',
        'vehiclelicence.smallmodularcarfree',
        'vehiclelicence.snowmobile',
        'vehiclelicence.snowmobilefree',
        'vehiclelicence.submarineduo',
        'vehiclelicence.submarineduofree',
        'vehiclelicence.submarinesolo',
        'vehiclelicence.submarinesolofree',
        'vehiclelicence.tomahasnowmobile',
        'vehiclelicence.tomahasnowmobilefree',
        'vehiclelicence.transportcopter',
        'vehiclelicence.transportcopterfree',
        'vehiclelicence.tug',
        'vehiclelicence.tugfree',
        'vehiclelicence.use',
        'vehiclelicence.vip',
        'vehiclelicence.workcart',
        'vehiclelicence.workcartaboveground',
        'vehiclelicence.workcartabovegroundfree',
        'vehiclelicence.workcartfree',
    ]);
    $rollout = raidlands_permissions_vip_rollout_defaults();
