      ...
      <article class="metal-panel home-map-preview">
        ...
        <?php if ($home_server_terrain_url !== '') : ?>
          <div
            ...
            data-live-refresh-seconds="<?= e((string) ($site_config['serverStats']['exchangeSeconds'] ?? 30)) ?>"
            ...
            data-map-replay-events-url="<?= e($base_path . 'api/server/map-replay-events.php') ?>"
            data-asset-base="<?= e($base_path . 'assets/') ?>"
            data-airstrike-ambient="true"
            ...
            data-timeline-url="<?= e($base_path . 'api/server/timeline.php') ?>"
            data-overlay-mode="live"
            data-overlay-heatmap="true"
            data-overlay-players="true"
            data-overlay-metric="all"
            data-overlay-range="6h"
            data-overlay-frames="24"
